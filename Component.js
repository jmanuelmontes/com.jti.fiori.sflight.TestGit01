...
sap.ui.core.UIComponent.extend("com.jti.fiori.sflight.TestGit01.Component", {
	metadata: {
		...
		rootView: "com.jti.fiori.sflight.TestGit01.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "RMTSAMPLEFLIGHT",
				serviceUrl: "/destinations/SAP_GATEWAY_DEMO"
			}
		},

		routing: {
			config: {
				routerClass: com.jti.fiori.sflight.TestGit01.MyRouter,
				viewType: "XML",
				viewPath: "com.jti.fiori.sflight.TestGit01.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.jti.fiori.sflight.TestGit01");
