sap.ui.core.mvc.Controller.extend("com.jti.fiori.sflight.TestGit01.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.jti.fiori.sflight.TestGit01.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "com.jti.fiori.sflight.TestGit01.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("carrid", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
